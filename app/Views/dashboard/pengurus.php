...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?= uri_string() === 'surat/surat_masuk_pengurus' ? 'active' : '' ?>">
                <a class="nav-link" href="<?= site_url('surat/surat_masuk_pengurus') ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="<?= site_url('surat/surat_masuk_pengurus') ?>">
                                    <div class="mr-3">
