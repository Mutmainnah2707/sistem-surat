<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php if (in_groups(['admin', 'pimpinan', 'satker', 'penpon'])): ?>
        <!-- Surat Masuk -->
    ...
    <?php if (in_groups(['pimpinan', 'admin'])): ?>
        <!-- Disposisi -->
        <li class="nav-item <?= uri_string() === 'disposisi' || uri_string() === 'disposisi/create' ? 'active' : '' ?>">
            <a class="nav-link" href="<?= site_url('disposisi') ?>">
                <i class="fas fa-fw fa-paper-plane"></i>
                <span>Disposisi</span>
            </a>
        </li>
