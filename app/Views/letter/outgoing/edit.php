...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="<?= site_url('surat-keluar/update/' . $letter['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control <?= validation_show_error('letter_from') ? 'is-invalid' : '' ?>" id="letter_from" name="letter_from" value="<?= old('letter_from') ? old('letter_from') : $letter['letter_from'] ?>">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control <?= validation_show_error('letter_number') ? 'is-invalid' : '' ?>" id="letter_number" name="letter_number" value="<?= old('letter_number') ? old('letter_number') : $letter['letter_number'] ?>">
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= validation_show_error('subject') ? 'is-invalid' : '' ?>" id="subject" name="subject" value="<?= old('subject') ? old('subject') : $letter['subject'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="letter_date" class="form-control <?= validation_show_error('letter_date') ? 'is-invalid' : '' ?>" id="letter_date" value="<?= old('letter_date') ? old('letter_date') : $letter['letter_date'] ?>">
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <div class="custom-file mb-3">
                    ...
                    <label class="custom-file-label" for="letter_file"><?= $letter['letter_file'] ? $letter['letter_file'] : 'Pilih file surat...' ?></label>
                    <div class="invalid-feedback">
