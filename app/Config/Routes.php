...
$routes->get('satkerdashboard', 'DashboardController::satkerdashboard');
$routes->get('pengurusdashboard', 'DashboardController::pengurusdashboard');
...
$routes->put('surat/update_surat_masuk/(:num)', 'SuratController::updateSuratMasuk/$1'); // Cari di controller
...
$routes->get('/settings/satker', 'SettingsController::settingSatker');
$routes->get('/settings/pengurus', 'SettingsController::settingPengurus');
...
$routes->group('satker', function ($routes) {
    ...
    $routes->get('surat_masuk/(:num)/delete', 'Satker\SuratMasukSatkerController::delete/$1'); // Proses hapus surat masuk
    ...
    $routes->get('surat_keluar/(:num)/edit', 'Satker\SuratKeluarSatkerController::edit/$1'); // Form edit surat keluar
    $routes->put('surat_keluar/(:num)', 'Satker\SuratKeluarSatkerController::update/$1'); // Proses update surat keluar
    $routes->get('surat_keluar/(:num)/delete', 'Satker\SuratKeluarSatkerController::delete/$1'); // Proses hapus surat keluar
});



// Route surat pengurus
